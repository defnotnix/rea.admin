...
import { getDistricts } from "./home.api";
...
export function BottomSection({
  ...
  const [activeTab, setActiveTab] = useState<string | null>("national");
  ...
  // Filter agendas based on selected tab
  const filteredAgendas =
    activeTab === "national"
      ? agendas.filter((a) => !a.category?.includes("District"))
      : selectedDistrict
        ? agendas.filter((a) => a.category?.includes(selectedDistrict))
        : agendas;
        ...
        <Container size="xl" className={styles.bottomAgendasContainer}>
          <Stack gap="md">
            <Group justify="space-between" align="flex-end">
              ...
              >
                <Tabs.List>
                  <Tabs.Tab value="national">National Agendas</Tabs.Tab>
                  <Tabs.Tab value="district">District-Level Agendas</Tabs.Tab>
                </Tabs.List>
              </Tabs>
            ...
            >
              ...
              <Tabs.Panel value="district" pt="md">
                <Stack gap="md">
                  <Group justify="space-between">
                    <Text size="sm">
                      Explore district agendas • Double-click map to interact
                    </Text>
                  ...
                  >
                    {filteredAgendas.length > 0 ? (
                      ...
                      <Box p="xl" ta="center">
                        <Text opacity={0.6}>
                          {selectedDistrict
                            ? `No agendas found for ${selectedDistrict}`
                            : "Select a district to view agendas"}
                        </Text>
                      </Box>
                    )}
                  </Carousel>
